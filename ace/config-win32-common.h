/* -*- C++ -*- */
// $Id: config-win32-common.h 2639 2015-08-21 22:03:20Z mitza $
...
// Ignore winnt.h definitions of _interlockedbittestandset() and
// _interlockedbittestandreset() to prevent double-definition in VC8
#if (_MSC_VER == 1400)
#define _PREFIX_
#endif /* _MSC_VER == 1400 */
